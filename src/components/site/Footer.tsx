        ...
        <div className="grid md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="mt-5 max-w-sm text-sm text-muted-foreground leading-relaxed">
              Premium residential and commercial construction services across New Jersey.
              Built on craftsmanship, run on trust.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-muted-foreground">
              <li className="flex items-center gap-2"><Phone className="h-3.5 w-3.5" /> (201) 450-0645</li>
              <li className="flex items-center gap-2"><Phone className="h-3.5 w-3.5" /> (201) 790-8029</li>
              <li className="flex items-center gap-2"><Mail className="h-3.5 w-3.5" />contact@cardenasconstructiollc.com</li>
              <li>Hackensack, NJ 07601</li>
            </ul>
          </div>
        </div>

        <div className="mt-14 border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
