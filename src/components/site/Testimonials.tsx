...
export function Testimonials() {
  return (
    <section id="testimonials" className="py-24 lg:py-32 bg-[color:var(--surface)]">
      <div className="container-x">
        <div className="max-w-2xl">
          <div className="text-xs font-semibold tracking-[0.2em] uppercase text-primary">Testimonials</div>
        ...
        <div className="mt-14 grid md:grid-cols-3 gap-6">
          {reviews.map((r, i) => (
            ...
            >
              ...
              <blockquote className="mt-5 text-foreground/85 leading-relaxed">"{r.text}"</blockquote>
